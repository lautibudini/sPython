...
def airport_types(airports_file, type_list): 
    """ 
    ...
    Args: 
      ...
      type_list: Una lista vacía para almacenar los tipos de aeropuertos. 
...
def airport_elevation (airports_file, elevation, airports_elevation):
    """
    ...
    Args:
      ...
      airports_elevation: Una lista vacía para almacenar los nombres de los aeropuertos de la elevación seleccionada. 
...
def airport_lower_or_higher(airports_file, elevation, elevation_choice, airports_elevation_list):
    """ 
    ...
    Args: 
      ...
      airports_elevation_list: Una lista vacía para almacenar los nombres de los aeropuertos y su elevación
      que cumplen con los requisitos dados.
...
def max_five_percent (data,max_percent):
      ...
      """
       ...
       Args:
          Recibe como parametro una lista con datos del csv censo 2022 y una lista donde 
          almacenará los porcentajes de pobreza de mayor a menor y la jurisdiccion.
...
def max_gender_jurisdiction (data, maxim):
     ...
     """
       ...
       Args:
          Recibe como parametro una lista con datos del csv censo 2022 y una lista donde 
          almacenará la jurisdicción con mas brecha poblacional segun sexo registrado al nacer junto a esa brecha
...
def capitals_list(reader, capital_index, capital_name, capital_connectivity):
...
def capitals_connectivity (capital_connectivity,reader, province, local, connection, list_capitals_connectivity):
     ...
     """
       ...
       Args:
          ...
          y la lista donde voy a almacenar las capitales con sus respectivas provincias y conectividad
